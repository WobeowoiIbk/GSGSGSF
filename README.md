...
CamShake:Stop()
    ...
    local i = "Ramaral123 hub: Blox Fruits"
...
local Window = OrionLib:MakeWindow({Name = "Ramaral123 hub: Blox Fruits", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Ramaral123 hub: Blox Fruits"})

OrionLib:MakeNotification({
	Name = "Ramaral123 hub: Blox Fruits",
...
OrionLib:MakeNotification({
	Name = "Ramaral123 hub: Blox Fruits",
	Content = "Ramaral123 hub: Blox Fruits",
	Image = "rbxassetid://119980140458596",
	Time = 25
})
...
W:AddLabel("[+] Ramaral123 hub: Blox Fruits is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Ramaral123 hub: Blox Fruits(Noitification)",
        ...
        while wait() do
            if _G.AutoObservation then
                if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                    OrionLib:MakeNotification({
                        Name = "Ramaral123 hub: Blox Fruits BOT",
